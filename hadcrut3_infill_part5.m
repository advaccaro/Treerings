...
station = find(navail(2001:end) >= ntime/5); no = numel(station);
...
save 'hadcrut3_part5_ttls_guess' X0 M0 C0 Xerr0 station
...
%
save 'hadcrut3_part5_iridge.mat' Xhf Mhf Chf Xerr hadcrut3 station
