...
station = find(navail(6001:end) >= ntime/10); no = numel(station);
...
save 'ghcn_part4_ttls_guess' X0 M0 C0 Xerr0 station
...
%
save 'ghcn_part4_iridge.mat' Xhf Mhf Chf Xerr hadcrut4 station
