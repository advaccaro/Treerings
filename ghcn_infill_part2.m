...
station = find(navail(2001:4000) >= ntime/10); no = numel(station);
...
save 'ghcn_part2_ttls_guess' X0 M0 C0 Xerr0 station
...
%
save 'ghcn_part2_iridge.mat' Xhf Mhf Chf Xerr hadcrut4 station
