...
station = find(navail(1251:end) >= ntime/5); no = numel(station);
...
save 'hadcrut3_h2_ttls_guess' X0 M0 C0 Xerr0 station
...
%
save 'hadcrut3_h2_iridge.mat' Xhf Mhf Chf Xerr hadcrut3 station
