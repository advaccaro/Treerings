...
station = find(navail(1001:1500) >= ntime/5); no = numel(station);
...
save 'hadcrut3_part3_ttls_guess' X0 M0 C0 Xerr0 station
...
%
save 'hadcrut3_part3_iridge.mat' Xhf Mhf Chf Xerr hadcrut3 station
