%tr_movavg_plot
function [trplot2] = tr_movavg_plot(data,n)
...
trmean2 = nmean(tcurve(n).trmovavg);
...
%create plot (divergence test)
    ...
    trplot2 = plot(t1,tr1-trmean,'g--',t1,st1,'r--',t2,tr2-trmean,'g--',t2,st2,'r--', tcurve(n).years, tcurve(n).trmovavg-trmean2, 'c', tcurve(n).years, tcurve(n).stmovavg, 'm', 'LineWidth', 2);
    hold on
